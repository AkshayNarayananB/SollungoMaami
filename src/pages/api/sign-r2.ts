...
const LibraryDropdowns = () => {
  ...
  const handleDownload = async (category, index, pdfName) => {
    ...
    try {
      ...
      // Push the updated array to Firestore
      ...
      link.href = data.url;
      // The backend forces 'attachment' so this will immediately download
